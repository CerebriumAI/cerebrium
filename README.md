...
The CLI supports shell autocompletion ([generated by Cobra](https://cobra.dev/docs/how-to-guides/shell-completion/)) for bash, zsh, fish, and PowerShell. Run `cerebrium completion --help` for details.
