...
// GetResourceMetrics provides a mock function for the type MockClient
func (_mock *MockClient) GetResourceMetrics(ctx context.Context, projectID string, appID string, opts api.ResourceMetricsOptions) (*api.ResourceMetrics, error) {
	ret := _mock.Called(ctx, projectID, appID, opts)
	...
	var r0 *api.ResourceMetrics
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string, api.ResourceMetricsOptions) (*api.ResourceMetrics, error)); ok {
		return returnFunc(ctx, projectID, appID, opts)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string, api.ResourceMetricsOptions) *api.ResourceMetrics); ok {
		r0 = returnFunc(ctx, projectID, appID, opts)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*api.ResourceMetrics)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, string, string, api.ResourceMetricsOptions) error); ok {
		r1 = returnFunc(ctx, projectID, appID, opts)
	} else {
		r1 = ret.Error(1)
	}
...
// MockClient_GetResourceMetrics_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetResourceMetrics'
type MockClient_GetResourceMetrics_Call struct {
	*mock.Call
}
...
//   - projectID string
//   - appID string
//   - opts api.ResourceMetricsOptions
func (_e *MockClient_Expecter) GetResourceMetrics(ctx interface{}, projectID interface{}, appID interface{}, opts interface{}) *MockClient_GetResourceMetrics_Call {
	return &MockClient_GetResourceMetrics_Call{Call: _e.mock.On("GetResourceMetrics", ctx, projectID, appID, opts)}
}

func (_c *MockClient_GetResourceMetrics_Call) Run(run func(ctx context.Context, projectID string, appID string, opts api.ResourceMetricsOptions)) *MockClient_GetResourceMetrics_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		...
		var arg3 api.ResourceMetricsOptions
		if args[3] != nil {
			arg3 = args[3].(api.ResourceMetricsOptions)
		}
		run(
			arg0,
			arg1,
...
func (_c *MockClient_GetResourceMetrics_Call) Return(resourceMetrics *api.ResourceMetrics, err error) *MockClient_GetResourceMetrics_Call {
	_c.Call.Return(resourceMetrics, err)
	return _c
}

func (_c *MockClient_GetResourceMetrics_Call) RunAndReturn(run func(ctx context.Context, projectID string, appID string, opts api.ResourceMetricsOptions) (*api.ResourceMetrics, error)) *MockClient_GetResourceMetrics_Call {
	_c.Call.Return(run)
	return _c
}
